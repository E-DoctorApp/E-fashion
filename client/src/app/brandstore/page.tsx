...
import liba3dha2 from "../../../public/Assests/images/FashionThatSpeaks.png"
import liba3dha3 from "../../../public/Assests/images/Rectang 31.png"
                        ...
                        <div className="overlap-2">
                                ...
                                <div className="overlap-3">
                                    <div className="group-5">
                                        ...
                                        <div className="frame-3">
                                            <Image width={500} height={500} className="mask-group" alt="Mask group" src={asset2} />
                                            <div className="group-7">
                                                <div className="text-wrapper-20">Physical</div>
                                            </div>
                                        </div>
                                        <div className="frame-4">
                                            <Image width={500} height={500} className="mask-group" alt="Mask group" src={asset3} />
                            ...
                            <div className="QTY-sec">
                                ...
                                <div className="group-9">
                                    ...
                                    <Image width={500} height={500} className="frame-5" alt="Frame" src={asset} onClick={() => {
                                        setCount(count + 1);
                                        console.log(count)
                                    }} />
                                </div>
                            ...
                            <div className="people">
                                ...
                                <div className="group-10">
                                    ...
                                    <Image width={500} height={500} className="ellipse" alt="Ellipse" src={taswira} />
                                </div>
                                <div className="group-11">
                                    <Image width={500} height={500} className="ellipse" alt="Ellipse" src={liba3dha} />
                                    <div className="text-wrapper-26">@farhan</div>
                                </div>
                            </div>
                        ...
                        <div className="overlap-4">
                            ...
                            <div className="group-12">
                                <div className="group-13">
                                    ...
                                    {/* <Image width={500} height = {500} className="vector-3" alt="Vector" src={asset4} /> */}
                                ...
                                <Image width={500} height={500} className="vector-4" alt="Vector" src="vector-2.svg" />
                            </div>
                            <div className="text-wrapper-29">Digital</div>
                            <Image width={500} height={500} className="vector-5" alt="Vector" src={asset1} />
                            <Image width={500} height={500} className="vector-6" alt="Vector" src="vector-5.svg" />
                            <Image width={500} height={500} className="group-14" alt="Group" src="/group-48095658.png" />
                            <Image width={500} height={500} className="group-15" alt="Group" src="/group-48095659.png" />
                            <div className="group-16">
                                ...
                                <Image width={500} height={500} className="vector-8" alt="Vector" src="vector-7.svg" />
                            </div>
                            <div className="group-18">
                                <div className="text-wrapper-28">Physical</div>
                                {/* <Image width={500} height={500} className="mask-group-2" alt="Mask group" src={asset2} /> */}
                                <i className="fa-brands fa-react" style={{ color: "#f5f9ff" }}></i>
                            </div>
                            <div className="group-19">
                                <div className="text-wrapper-28">Exclusive</div>
                                {/* <Image width={500} height={500} className="mask-group-2" alt="Mask group" src="/mask-group-3.png" /> */}
                                ...
                                <div className="div-2">
                                    <div className="div-2">
                                        <div className="overlap-group-2">
                                            ...
                                            <Image width={500} height={500} className="rectangle" alt="Rectangle" src={liba3dha} />
                                            <div className="text-wrapper-17">Current Bid</div>
                                        </div>
                                    </div>
                                    <div className="group-4">
                                ...
                                <div className="overlap-5">
                                    <div className="div-2">
                                        <div className="overlap-group-2">
                                            ...
                                            <div className="text-wrapper-16">0.005 ETH</div>
                                            <div className="text-wrapper-17">Current Bid</div>
                                            <Image width={500} height={500} className="rectangle" alt="Rectangle" src={liba3dha2} />
                                        </div>
                                    </div>
                                    <div className="group-4">
                                        <div className="frame-2">
                                ...
                                <div className="overlap-6">
                                    <div className="div-2">
                                        <div className="overlap-group-2">
                                            ...
                                            <div className="text-wrapper-16">0.005 ETH</div>
                                            <div className="text-wrapper-17">Current Bid</div>
                                            <Image width={500} height={500} className="rectangle" alt="Rectangle" src={liba3dha3} />
                                        </div>
                                    </div>
                                    <div className="group-4">
                                        <div className="frame-2">
